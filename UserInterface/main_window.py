...
Поиск / сортировка / фильтр по поставщику — менеджер и администратор.
Добавление / редактирование / удаление товара — администратор.
Кнопка «Заказы» — менеджер и администратор.
"""
